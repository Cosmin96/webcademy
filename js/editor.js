(function() {
	...
	html_editor.setValue('<p>Hello Webcademy</p>');
	...
	*/
	...
	for (var i = 0; i < cms.length; i++) {
		...
		cms[i].style.fontSize = "large";
		//cms[i].style.background = "#272822";
		cms[i].style.background = "#e8e1ce";
		cms[i].style.color = "#000000";

	}
	cms = document.querySelectorAll('.CodeMirror-scroll');
	for (i = 0; i < cms.length; i++) {
		cms[i].style.height = '95%';
	}
